...
pcl::PointCloud<pcl::PointXYZ>::Ptr PCL::generatePointCloud(std::vector<cv::Point3f> pts3D)
{
...
pcl::PointCloud<pcl::PointXYZRGB>::Ptr PCL::generatePointCloudColor(std::vector<cv::Point3f> pts3D, std::vector<cv::Vec3b> pts_color)
{
